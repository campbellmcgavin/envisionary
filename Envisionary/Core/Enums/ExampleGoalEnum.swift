...
enum ExampleGoalEnum: Int, CaseIterable {
    ...
    func toGoal(parentId: UUID?, imageId: UUID?, archetype: ArchetypeType) -> CreateGoalRequest {
        switch self{
        case .decade:
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .critical, startDate: Date(), endDate: self.toEndDate(date: Date()), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .decade, parent: parentId)
            
        case .year0:
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .critical, startDate: Date(), endDate: self.toEndDate(date: Date()), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .year, parent: parentId)
            
        case .year1:
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .critical, startDate: Date().AdvanceYear(forward: true), endDate: self.toEndDate(date: Date().AdvanceYear(forward: true)), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .year, parent: parentId)
        case .year1_month1:
            let date = Date().AdvanceYear(forward: true)
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .critical, startDate: date, endDate: self.toEndDate(date: date), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .month, parent: parentId)
        case .year1_month1_week1:
            let date = Date().AdvanceYear(forward: true)
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .critical, startDate: date, endDate: self.toEndDate(date: date), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .week, parent: parentId)
            
            
        case .year1_month1_week1_day1:
            let date = Date().AdvanceYear(forward: true)
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .moderate, startDate: Date(), endDate: self.toEndDate(date: date), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .day, parent: parentId)
        case .year1_month1_week1_day2:
            let date = Date().AdvanceYear(forward: true).AdvanceDay(forward: true)
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .high, startDate: date, endDate: self.toEndDate(date: date), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .day, parent: parentId)
        case .year1_month1_week1_day3:
            let date = Date().AdvanceYear(forward: true).AdvanceWeek(forward: true)
            return CreateGoalRequest(title: self.toTitle(archetype: archetype), description: self.toDescription(archetype: archetype), priority: .low, startDate: date, endDate: self.toEndDate(date: date), percentComplete: 0, image: imageId, aspect: .academic, timeframe: .day, parent: parentId)
