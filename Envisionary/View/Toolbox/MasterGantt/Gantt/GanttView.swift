...
//                        GanttMainDiagram(parentGoalId: goalId, goalId: goalId, offset: offset, focusGoal: $focusGoal, filteredGoals: $filteredGoals, shouldShowAll: $shouldShowAll, expandedObjects: .constant([UUID]()), value: { localGoalId in
//                            
...
//                GanttCard(parentGoalId: self.goalId, goalId: goalId, leftPadding: leftPadding, selectedGoalId: $focusGoal, shouldShowPadding: $shouldShowPadding)
