...
//    var body: some View {
//        
//        Modal(modalType: .setup, objectType: objectType, isPresenting: $isPresenting, shouldConfirm: .constant(false), isPresentingImageSheet: .constant(false), allowConfirm: true, modalContent: {
//            
////            SetupGoalIntro(canProceed: .constant(false))
////            TutorialGetStarted(canProceed: false)
//            
//            SetupStepContent(setupStep: $setupStep, isFinishedWithMessages: $isFinishedWithMessages, isFinishedWithActions: $isFinishedWithActions, bumpScrollView: $bumpScrollView, shouldAct: $shouldAct)
//                .padding(8)
//            
